...
const main = () => {
    // สร้างธนาคาร
    const bank = new Bank('ABC Bank', '123 Main Street', '67890');
    
    // สร้างลูกค้าแรก
    const customer1 = new Customer('John Doe', '123 Oak Avenue', '1234567890', 'johndoe@example.com');
    
    // สร้างลูกค้าที่สอง
    const customer2 = new Customer('Jane Smith', '456 Maple Street', '0987654321', 'janesmith@example.com');

    // สร้างบัญชีให้กับลูกค้าแรก
    const account1 = bank.createAccount("KBANK", 2000);

    // สร้างบัญชีให้กับลูกค้าที่สอง
    const account2 = bank.createAccount("KBANK", 1000);
